...
const projects = [{
  ...
  images: ["/DJI_0375.jpg", "/AceHealthcareDerma.jpg", "/Amrith3.jpg", "/BOCKandy10.jpg"],
  ...
  images: ["/1721638265449.jpg", "/BOCTrinco.jpg", "/ccp.jpg", "/ColomboUrbanRegeneration.jpg"],
  ...
  images: ["/CTBFuel.jpg", "/Sanjeewa.jpg", "/GalleUdugama2.jpg"],
        ...
        <AnimatePresence mode="wait">
          ...
          delay: 0.1
            ...
            <motion.div className="flex items-center text-yellow-400 font-semibold group/link">
              <Link href={project.link} className="flex items-center hover:text-yellow-300">
                Read More
