...
import { NewsFeed, newsFeedService } from "@/app/admin/secure/services/newsFeedService";
...
const NewsFeedPage: React.FC = () => {
  ...
  const handleEdit = (article: NewsFeed) => {
    setEditingArticle({
      ...article,
      createTime: article.createTime ?? null, // Ensure createTime is null if not present
    });
    setIsModalOpen(true);
  };
