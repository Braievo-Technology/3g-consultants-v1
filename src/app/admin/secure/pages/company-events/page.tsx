...
const CompanyEvents: React.FC = () => {
    ...
    const fetchEvents = async () => {
        try {
            ...
            // Convert to proper JS Date if needed
    ...
    const handleDelete = async (event: ApiEvent) => {
        if (window.confirm(`Are you sure you want to delete "${event.event_type}"?`)) {
            try {
            ...
            <div className="p-4 sm:p-6 lg:p-8">
                ...
                <div className="mb-6 flex flex-col gap-4 sm:flex-row">
                    ...
                    <div className="relative w-full sm:w-48 lg:w-64">
                        <FilterIcon size={20} className="absolute left-3 top-2.5 text-gray-400" />
                        <select
