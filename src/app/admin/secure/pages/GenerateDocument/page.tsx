    ...
    useEffect(() => {
        const fetchProjects = async () => {
            ...
            try {
                ...
                const allProjects: ExtendedProject[] = responses.flatMap((res) => res.data)
                ...
                <div className="mx-auto max-w-7xl">
                    <div className="mb-8">
                        ...
                        <p className="mt-2 text-sm text-gray-600">
                            Select one or more categories and enter client details to generate a document
                        </p>
                    </div>
                    <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                            <label className="block text-sm font-medium text-gray-700">Select Project Categories</label>
                            <div className="mt-1">
                                <CategorySelect
                    ...
                    <div className="mb-8">
                        <div className="flex gap-4 items-center">
                            <button
                                ...
                                disabled={
                                    isLoading || isGenerating || selectedCategories.length === 0 || !clientName.trim()
                                }
                    ...
                    <div className="space-y-4">
                        {isLoading ? (
                            ...
                            <div className="rounded-md bg-red-50 p-4 text-center text-red-700">{error}</div>
                        ) : projects.length > 0 ? (
                            <div className="space-y-4">
