...
export const Header: React.FC<HeaderProps> = ({
  ...
  return <header className="flex h-16 items-center justify-between border-b border-gray-200 bg-white px-4 lg:px-6">
      <div className="flex items-center">
        <button className="mr-3 rounded-md p-1 text-[#f1c233] hover:bg-gray-100 lg:hidden" onClick={onMenuClick}>
          <MenuIcon size={24} />
        </button>
        <div>
          <h1 className="text-lg font-medium sm:text-xl lg:text-2xl text-[#f1c233]">
...
{/*        <div className="relative hidden md:block">
        ...
        <button onClick={() => setIsProfileModalOpen(true)} className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-500 text-sm text-white hover:bg-blue-600 transition-colors sm:h-10 sm:w-10 sm:text-base">
          JD
        </button>
      </div>
