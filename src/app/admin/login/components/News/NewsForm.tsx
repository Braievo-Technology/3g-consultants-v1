  ...
  return <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          {formData.imagePreview ? <div className="relative h-48 w-full overflow-hidden rounded-lg">
            ...
            </div> : <label className="flex h-48 w-full cursor-pointer items-center justify-center rounded-lg border-2 border-dashed border-gray-300 hover:border-gray-400">
      ...
      <div>
        ...
        <input type="text" value={formData.summary} onChange={e => setFormData(prev => ({
        ...prev,
      ...
      }))} rows={4} className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500" required />
      </div>
      {/* Status */}
      <div>
        <label className="block text-sm font-medium text-gray-700">
