...
const jobOpenings = [
  {
    ...
    description:
      "Lead structural engineering projects and mentor junior engineers while ensuring compliance with building codes and safety standards.",
    requirements: [
      "Bachelor's degree in Structural Engineering or Civil Engineering",
      "Professional Engineering (PE) license required",
      "Experience with structural analysis software (ETABS, SAP2000)",
      "Strong knowledge of building codes and standards",
      "Proven track record of managing complex structural projects",
      "Excellent leadership and communication skills",
    ],
  },
  // ... rest of the job openings from CareersPage
];
